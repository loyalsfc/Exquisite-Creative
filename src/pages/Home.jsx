  ...
  return (
    <div className='container mx-auto'>
        ...
        <section className='mb-[112px]'>
            ...
            />
            <div className='flex'>
                <div  className='w-2/5 h-[281px] relative'>
                 ...
                 <div className='w-3/5 flex flex-wrap items-start justify-end gap-4 pl-4'>
                    <Tools 
                        cat="Languages"
        ...
        <section>
            ...
            />
            <div className='flex items-center'>
                <article className='text-secondary w-1/2 shrink-0'>
        ...
        <section className='mb-[113px]'>
            <Divider
                name="contacts"
            />
            <div className='flex justify-between text-secondary pt-11'>
                <article>
                    <p className='w-[500px] max-w-full'>We are interested in freelance opportunities. However, if you have other request or question, don’t hesitate to contact us</p>
                </article>
